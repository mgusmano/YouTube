...
folder are mapped to the application's root namespace, 'ExtJs5YouTube'. This is set in
`"app.json"`:

    "sass": {
        "namespace": "ExtJs5YouTube"
    }
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'ExtJs5YouTube' in the same way
as `"ExtJs5YouTube/sass/src"`.
