...
folder are mapped to the application's root namespace, 'EMSPEEDExt5'. This is set in
`"app.json"`:

    "sass": {
        "namespace": "EMSPEEDExt5"
    }
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'EMSPEEDExt5' in the same way
as `"EMSPEEDExt5/sass/src"`.
